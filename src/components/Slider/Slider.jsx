                ...
                <div className="hero min-h-screen rounded-3xl" style={{ backgroundImage: 'url(https://i.ibb.co/7479SZ1/generative-ai-chef-food-presentation-28914-24291.jpg)' }}>
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="md:w-[897px]">
                            ...
                            <p className="mb-5">Our chefs knows how to cook healthy good food. Now your turn to feel it. We believe its need you to survive. Nutrients provide the energy our bodies need to function. The energy in food is measured in units called calories !!!!</p>
                            <div className=''>
